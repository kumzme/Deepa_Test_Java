...
public class Test_02 {
    ...
    public static  void main(String args[])throws Exception{
        ...
        ArrayList<String> a2 =  file_Read(file_paths.get(3),"src");
        l.info(a2);
        display_All_Values_In_Array(a2);
        JSONObject a3 = file_Read_Json(file_paths.get(3),"resources") ;
        display_All_Values_In_Array(a3);
        JSONObject j1 =  search_Write_Json("a");

        //File aa = write_File_Json(op_Data_Folder,a3);
//        l.info(aa);
        File a1 = write_File_Json(op_Data_Folder + "/OP_File1.txt", j1);
        l.info(a1);
